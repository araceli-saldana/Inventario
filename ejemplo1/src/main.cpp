...
StaticJsonDocument<128> temperaturas;

const char *urlPost = "http://192.168.0.9/esp32-api/public/api/sensores";
...
void RCamarasCongelacion(){
      temperaturas.clear();
      temperaturas["temperatura"] = random(30);
      temperaturas["fecha"] = reloj->timeStringBuff;
      temperaturas["idCamara"] = ;
      serializeJsonPretty(temperaturas,Serial);
